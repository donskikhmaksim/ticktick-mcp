...
# Внутри заменителя ДВОЕТОЧИЕ, а не «·» — Д3 (2026-08-09): «·» с теми же
# пробелами вокруг делит мета-поля компактной строки, и у безымянной задачи с
# вложением он встречался бы дважды, разваливая разбор у внешнего бота. Тест
# ветки Д1 писался до этой правки и после слияния ждал старую форму.
