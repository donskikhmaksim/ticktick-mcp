...
_SCANNED_FILES = [
    _SRC / "server.py",
    # Разнос главного файла (1.2.4 захода 1, 2026-08-09) увёл часть его строк
    # в эти два модуля. Без них проверка на утечку сырых исключений молча
    # перестала бы смотреть на весь гейт согласия и всё исполнение по кнопке —
    # то есть ровно на код, чьи ответы уходят владельцу в Telegram.
    _SRC / "consent.py",
    _SRC / "tg_auto_execute.py",
